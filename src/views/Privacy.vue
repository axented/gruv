...
<div>
  ...
  <div class="privacy container py-10">
    <h1 class="leading-loose font-bold text-4xl">Privacy Policy</h1>
    ...
    <li><b>Application</b> means
        the software program provided by the Company downloaded by You on any
        electronic device, named gr&#252;v.it</li>
    <li><b>Company</b> (referred
        to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
        &quot;Our&quot; in this Agreement) refers to gr&#252;v.it.</li>
    <li><b>Country</b> refers to: Mexico</li>
    <li><b>Device</b> means
        any device that can access the Service such as a computer, a cellphone or
        a digital tablet.</li>
    <li><b>Personal Data</b> is any
        information that relates to an identified or identifiable individual.</li>
    <li><b>Service</b> refers
    ...
    <li><b>Third-party
        Social Media Service</b> refers to any website or any social network website
        through which a User can log in or create an account to use the Service.</li>
    <li><b>Either Usage
        Data refers to data collected automatically,</b> generated by
    ...
    <h1 class="leading-loose font-bold text-4xl">Collecting and Using Your Personal Data</h1>

    <h2 class="leading-loose font-bold text-xl">Types of Data Collected</h2>

    <h3 class="leading-loose font-bold text-lg">Personal Data</h3>
    ...
    <h3 class="leading-loose font-bold text-lg">Usage Data</h3>

    <p>Usage
    Data is collected automatically when using the Service.</p>
    ...
    <h3 class="leading-loose font-bold text-lg">Information
    from Third-Party Social Media Services</h3>
    ...
    address, Your activities or Your contact list associated with that account.</p>

    <p>You may
    also have the option of sharing additional information with the Company through
    ...
    <h3 class="leading-loose font-bold text-lg">Information
    Collected while Using the Application</h3>

    <p>While
    using Our Application, in order to provide features of Our Application, We may
    collect, with Your prior permission:</p>

    <ul class="list-disc list-inside">
    <li>Pictures and
        video and other information from your Device's camera and photo library</li>
    </ul>

    <p>We use
    this information to provide features of Our Service, to improve and customize
    ...
    <p>You can
    enable or disable access to this information at any time, through Your Device
    settings.</p>

    <h2 class="leading-loose font-bold text-xl">Use of
    Your Personal Data</h2>

    <p>The
    Company may use Personal Data for the following purposes:</p>

    <ul class="list-disc list-inside">
    <li><b>To provide and
        maintain our Service</b>, including to monitor the usage of our Service.</li>
    <li><b>To manage Your
        Account:</b> to
    ...
    <li><b>For the
        performance of a contract:</b> the development, compliance and
    ...
    <li><b>To manage Your
        requests:</b> To
        attend and manage Your requests to Us.</li>
    <li><b>For business
        transfers:</b> We
    ...
    <p>We may
    share Your personal information in the following situations:</p>
    ...
    <li><b>With
        ...
        Our parent company and any other subsidiaries, joint venture partners or
    ...
    <h2 class="leading-loose font-bold text-xl">Retention
    of Your Personal Data</h2>
    ...
    <h2 class="leading-loose font-bold text-xl">Transfer
    of Your Personal Data</h2>
    ...
    <h2 class="leading-loose font-bold text-xl">Disclosure
    of Your Personal Data</h2>

    <h3 class="leading-loose font-bold text-lg">Business
    Transactions</h3>
    ...
    <h3 class="leading-loose font-bold text-lg">Law
    enforcement</h3>
    ...
    <h3 class="leading-loose font-bold text-lg">Other
    ...
    <li>Protect
        against legal liability</li>
    </ul>

    <h3 class="leading-loose font-bold text-lg">Security of Your Personal Data</h3>
    ...
    <h1 class="leading-loose font-bold text-4xl">Children's
    Privacy</h1>
    ...
    <p>If We
    need to rely on consent as a legal basis for processing Your information and
    ...
    <h1 class="leading-loose font-bold text-4xl">Links
    to Other Websites</h1>
    ...
    <h1 class="leading-loose font-bold text-4xl">Changes
    to this Privacy Policy</h1>
    ...
    <h1 class="leading-loose font-bold text-4xl">Contact
    Us</h1>
    ...
    <ul class="list-disc list-inside">
    <li>By email: <a class="underline text-primary" href="mailto:gruv.itapp@gmail.com">gruv.itapp@gmail</a></li>
    <li>By visiting
