    ...
    <div class="privacy container py-10">
      ...
      <ul class="list-disc list-inside">
        ...
        <li>
          ...
          downloaded by You on any electronic device, named gr&#252;v.it
        </li>
        <li>
        ...
        <li>
          <b>Either Usage Data refers to data collected automatically,</b>
      ...
      <h3 class="leading-loose font-bold text-lg">
      ...
      <ul class="list-disc list-inside">
        <li>
          Pictures and video and other information from your Device's camera and
          photo library
        </li>
      </ul>
      ...
      <h2 class="leading-loose font-bold text-xl">Use of Your Personal Data</h2>
      ...
      <h3 class="leading-loose font-bold text-lg">Business Transactions</h3>
      ...
      <h3 class="leading-loose font-bold text-lg">Law enforcement</h3>
      ...
      <h3 class="leading-loose font-bold text-lg">Other legal requirements</h3>
      ...
      <h1 class="leading-loose font-bold text-4xl">Children's Privacy</h1>
      ...
      <h1 class="leading-loose font-bold text-4xl">Links to Other Websites</h1>
      ...
      <ul class="list-disc list-inside">
        <li>
          By email:
          <a class="underline text-primary" href="mailto:gruv.itapp@gmail.com"
            >gruv.itapp@gmail</a
          >
        </li>
        <li>
