<template>
  <div>
    ...
    <div class="container py-10">
      <h1 class="leading-loose font-bold text-4xl">
      ...
      <p>
        ...
        External Service, including but not limited to financial, medical and
        location information, is for general informational purposes only and is
        not guaranteed by Licensor or its agents. You will not use the External
        ...
        Licensor or any third party. You agree not to use the External Services
        to harass, abuse, stalk, threaten or defame any person or entity, and
        that Licensor is not responsible for any such use. External Services may
        not be available in all languages or in your Home Country, and may not
        be appropriate or available for use in any particular location. To the
        extent you choose to use such External Services, you are solely
        responsible for compliance with any applicable laws. Licensor reserves
        the right to change, suspend, remove, disable or impose access
        restrictions or limits on any External Services at any time without
        notice or liability to you.&nbsp;
      </p>

      <p>
        e. No Warranty: You expressly acknowledge and agree that the use of the
        ...
        licensor hereby disclaims all warranties and conditions with respect to
        the licensed application and any services either express, implied or
        statutory, including, but not limited to, the implied warranties and/or
        conditions of merchantability of the satisfactory quality, of fitness
        ...
        advice given by licensor or its authorized representatives shall create
        a warranty. Should the licensed application or services prove defective,
      ...
      <button class="button bg-primary text-white rounded-full p-2 mt-5">
        <router-link to="/">{{ $t("content.gobackbtn") }}</router-link>
      </button>
    </div>
  </div>
</template>
