    ...
    <div class="terms container py-10">
      ...
      <ul class="list-disc list-inside">
        ...
        <li>
          ...
          this Agreement) refers to gr&#252;v.it .
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to gr&#252;v.it , accessible from
          <a href="http://gruvitapp.com/" target="_blank"
            >http://gruvitapp.com</a
          >
        </li>
        <li>
      ...
      <h2 class="leading-loose font-bold text-xl">Links to Other Websites</h2>
      ...
      <h2 class="leading-loose font-bold text-xl">Limitation of Liability</h2>
      ...
      <h2 class="leading-loose font-bold text-xl">
      ...
      <h2 class="leading-loose font-bold text-xl">Governing Law</h2>
      ...
      <h2 class="leading-loose font-bold text-xl">Disputes Resolution</h2>
      ...
      <h2 class="leading-loose font-bold text-xl">Severability and Waiver</h2>
