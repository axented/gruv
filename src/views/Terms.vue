...
<div>
  ...
  <div class="terms container py-10">
    <h1 class="leading-loose font-bold text-4xl">Terms and Conditions</h1>

    <p>Last updated: October 12, 2021</p>
    <p>Please read these terms and conditions carefully before using Our Service.</p>

    <h1 class="leading-loose font-bold text-4xl">Interpretation and Definitions</h1>

    <h2 class="leading-loose font-bold text-xl">Interpretation</h2>

    <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>

    <h2 class="leading-loose font-bold text-xl">Definitions</h2>
...
<ul class="list-disc list-inside">
 ...
 <li> <strong>Device</strong> means
     ...
     a digital tablet.</li>
 <li> <strong>Service</strong> refers
     to the Website.</li>
 <li> <strong>Terms and
     Conditions</strong> (also
     ...
     Service. </li>
 <li> <strong>Third-party
     Social Media Service</strong> means any services or content (including
...
<h2 class="leading-loose font-bold text-xl">Acknowledgment</h2>
...
Policy carefully before using Our Service.</p>

<h2 class="leading-loose font-bold text-xl">Links
to Other Websites</h2>
...
<h2 class="leading-loose font-bold text-xl">Termination</h2>

<p>We may
terminate or suspend Your access immediately, without prior notice or
...
<h2 class="leading-loose font-bold text-xl">Limitation
of Liability</h2>
...
<h2 class="leading-loose font-bold text-xl">&quot;AS
IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
...
<h2 class="leading-loose font-bold text-xl">Governing
Law</h2>

<p>The
laws of the Country, excluding its conflicts of law rules, shall govern this
...
<h2 class="leading-loose font-bold text-xl">Disputes
Resolution</h2>

<p>If You
have any concern or dispute about the Service, You agree to first try to
resolve the dispute informally by contacting the Company.</p>

<h2 class="leading-loose font-bold text-xl">For
European Union (EU) Users</h2>

<p>If You
are a European Union consumer, you will benefit from any mandatory provisions
of the law of the country in which you are resident in.</p>

<h2 class="leading-loose font-bold text-xl">United
States Legal Compliance</h2>
...
<h2 class="leading-loose font-bold text-xl">Severability
and Waiver</h2>

<h2 class="leading-loose font-bold text-xl">Severability</h2>
...
<h2 class="leading-loose font-bold text-xl">Waiver</h2>
...
shall be the waiver of a breach constitute a waiver of any subsequent breach.</p>

<h2 class="leading-loose font-bold text-xl">Translation
Interpretation</h2>
...
<h2 class="leading-loose font-bold text-xl">Changes
to These Terms and Conditions</h2>
